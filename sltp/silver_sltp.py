...
Usage:
    python silver_sltp.py --symbol SILVER --sl 28.50 --tp 31.50
    python silver_sltp.py --symbol GOLD --sl 4600 --tp 4750
    python silver_sltp.py --symbol BTCUSD --sl 63500 --tp 72800
"""
